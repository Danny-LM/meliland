...
export const PLANET_DATA: PlanetData[] = [
	{
		...
		title: 'Mi Refugio',
		description:
			'Hace algunos años hicimos esa casita del fondo, jaja es curioso, no? Hace un mes iniciamos pero inconsciente y consciente ya lo sabíamos... sabíamos que queríamos vivir juntos y yo sé que un día así será, porque sin importar el lugar, tú te has vuelto mi refugio :D y quiero estar 80 billones de años contigo',
	...
	},
	{
		...
		title: 'Meliland',
		description:
			'Hace mucho te di una plaza como un regalo de cumpleaños, pero esa plaza se perdió... bueno no te preocupes, ya lo viste hace unos días, te estoy construyendo una nueva y mejor :D Además no será solo una plaza, será una ciudad que va a crecer con todos los lugares que quiero ver contigo una vez superemos esos 900 km jajaja',
